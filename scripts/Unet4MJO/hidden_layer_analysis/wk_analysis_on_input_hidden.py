...
feature_map = np.asarray(outfields['hidden1'])
...
hid5_all.to_netcdf('/pscratch/sd/l/linyaoly/ERA5/Unet4MJO/1map_MCDO_ERA5_yproj_xfft_4gpus_new/hidden_analysis/hid1_'+flag+'.nc')

del feature_map, hid5_sm_sym, hid5_sm_asym, hid5_background, hid5_sym_norm, hid5_asym_norm, hid5_sym_norm_sig, hid5_asym_norm_sig
